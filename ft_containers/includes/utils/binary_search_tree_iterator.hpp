...
class BST_reverse_iterator {
    public:
		...
		*/
        ...
        BST_reverse_iterator() : _ptr(NULL)
        {};

        BST_reverse_iterator(pointer ptr) : _ptr(ptr)
        {};

        BST_reverse_iterator(const BST_reverse_iterator & obj) {
            *this = obj;
        };
		...
		*/
		...
		bool	operator==(const BST_reverse_iterator & rhs) {
			return (_ptr == rhs._ptr);
		}
		bool	operator!=(const BST_reverse_iterator & rhs) {
			return (_ptr != rhs._ptr);
		...
		// These two are used to compare const_iterator with iterator
		bool	operator==(const BST_const_reverse_iterator<Key, T> & rhs) {
			return (_ptr == rhs._ptr);
		}
		bool	operator!=(const BST_const_reverse_iterator<Key, T> & rhs) {
			return (_ptr != rhs._ptr);
	...
	public:
		...
		// pointer needs to be public to be used in BST_const_iterator
		// BST_const_iterator(const BST_reverse_iterator<Key, T> & obj);
		// bool	operator==(const BST_reverse_iterator<Key, T> & rhs);
		// bool	operator!=(const BST_reverse_iterator<Key, T> & rhs);
        pointer                                 _ptr;
};
...
class BST_const_reverse_iterator {
    public:
		...
		*/
        ...
        BST_const_reverse_iterator() : _ptr(NULL)
        {};

        BST_const_reverse_iterator(pointer ptr) : _ptr(ptr)
        {};

        BST_const_reverse_iterator(const BST_const_reverse_iterator & obj) {
            *this = obj;
        };

		// This is to convert from Reverse Iterator to Const_Reverse_Iterator
		// To make stuff like this work:
		//    ft::map<int, std::string> mapA;
		//    ft::map<int, std::string>::const_reverse_iterator itA = mapA.rbegin();
        BST_const_reverse_iterator(const BST_reverse_iterator<Key, T> & obj) {
            _ptr = obj._ptr;
        };
		...
		*/
		...
		bool	operator==(const BST_const_reverse_iterator & rhs) {
			return (_ptr == rhs._ptr);
		}
		bool	operator!=(const BST_const_reverse_iterator & rhs) {
			return (_ptr != rhs._ptr);
		...
		// These two are used to compare const_reverse_iterator with reverse_iterator
		bool	operator==(const BST_reverse_iterator<Key, T> & rhs) {
			return (_ptr == rhs._ptr);
		}
		bool	operator!=(const BST_reverse_iterator<Key, T> & rhs) {
