...
int		map_argument(std::string argument) {
	...
	if (!argument.compare("93")) { header_text("map"); testMap::member_types__const_reverse_iterator__default_member_functions(); return 0; }
	else if (!argument.compare("94")) { header_text("map"); testMap::member_types__const_reverse_iterator__relational_operators(); return 0; }
	else if (!argument.compare("95")) { header_text("map"); testMap::member_types__const_reverse_iterator__dereferences(); return 0; }
	...
	else if (!argument.compare("102")) { header_text("map"); testMap::member_functions__operator_equal(); return 0; }

	if (!argument.compare("103")) { header_text("map"); testMap::member_functions__iterator__begin(); return 0; }
	else if (!argument.compare("104")) { header_text("map"); testMap::member_functions__iterator__end(); return 0; }
...
void	welcome_message() {
	...
	std::cout << "*          const_reverse_iterator:				    *" << std::endl;
	std::cout << "*              Default Member Functions			      93    *" << std::endl;
	std::cout << "*              Relational Operators			      94    *" << std::endl;
	std::cout << "*              Dereferences				      95    *" << std::endl;
	std::cout << "*              Increment and Decrement Operators	      96    *" << std::endl;
	std::cout << "*              Extras:						    *" << std::endl;
	std::cout << "*                  Reverse It With Const Reverse It	      97    *" << std::endl;
	std::cout << "*								    *" << std::endl;
	std::cout << "*      Member Functions:					    *" << std::endl;
	std::cout << "*          Default:						    *" << std::endl;
	...
	std::cout << "*              operator=				     102    *" << std::endl;
	std::cout << "*          Iterators:						    *" << std::endl;
	std::cout << "*              begin					     103    *" << std::endl;
	std::cout << "*              end					     104    *" << std::endl;
	std::cout << "*              rbegin					     105    *" << std::endl;
	std::cout << "*              rend					     106    *" << std::endl;
	std::cout << "*          Capacity:						    *" << std::endl;
	std::cout << "*              empty					     107    *" << std::endl;
	std::cout << "*              size					     108    *" << std::endl;
	std::cout << "*              max_size					     109    *" << std::endl;
	std::cout << "*          Element Access:					    *" << std::endl;
	std::cout << "*              operator[]				     110    *" << std::endl;
	std::cout << "*          Modifiers:						    *" << std::endl;
	std::cout << "*              insert:					            *" << std::endl;
