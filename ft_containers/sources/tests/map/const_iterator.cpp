...
// 			std::cout << "  vector<int>::const_iterator itA = vectorA.begin();" << std::endl;
// 			std::cout << "  vector<int>::const_iterator itB = vectorB.begin();" << std::endl << std::endl;
...
// 	ft::vector<int>::const_iterator itDefault;
// 			std::cout << "  vector<int>::const_iterator	itDefault;" << std::endl;
// 			std::cout << std::endl;
...
// 	ft::vector<int>::const_iterator itCopyConstructor(itA);

// 			std::cout << "  vector<int>::const_iterator	itCopyConstructor(itA);" << std::endl << std::endl;
...
// 	ft::vector<int>::const_iterator itCopyAssigment = itA;

// 			std::cout << "  vector<int>::const_iterator itCopyAssigment = itA;" << std::endl << std::endl;
...
// 	ft::vector<int>::const_iterator itA = vectorA.begin();
// 	ft::vector<int>::const_iterator itB = vectorB.begin();
// 	ft::vector<int>::const_iterator itC = itA;

// 			std::cout << "  vector<int>::const_iterator itA = vectorA.begin();" << std::endl;
// 			std::cout << "  vector<int>::const_iterator itB = vectorB.begin();" << std::endl;
// 			std::cout << "  vector<int>::const_iterator itC = itA;" << std::endl << std::endl;
// 			std::cout << "      *itA is	" << *itA << std::endl;
// 			std::cout << "      *itB is	" << *itB << std::endl;
...
// 	ft::vector<int>::const_iterator const_itA = vectorA.begin();

// 			std::cout << "  vector<int>::iterator itA = vectorA.begin();" << std::endl;
// 			std::cout << "  vector<int>::const_iterator const_itA = vectorA.begin();" << std::endl;
// 			std::cout << std::endl;
