...
void	testMap::member_types__const_reverse_iterator__default_member_functions() {
	...
	ft::map<int, std::string>::const_reverse_iterator itA = mapA.rbegin();
	ft::map<int, std::string>::const_reverse_iterator itB = mapB.rbegin();

			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itA = mapA.rbegin();" << std::endl;
			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itB = mapB.rbegin();" << std::endl << std::endl;
	...
	ft::map<int, std::string>::const_reverse_iterator itDefault;
			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itDefault;" << std::endl;
			std::cout << std::endl;
	...
	ft::map<int, std::string>::const_reverse_iterator itCopyConstructor(itA);

			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itCopyConstructor(itA);" << std::endl << std::endl;
	...
	ft::map<int, std::string>::const_reverse_iterator itCopyAssigment = itA;

			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itCopyAssigment = itA;" << std::endl << std::endl;
...
void	testMap::member_types__const_reverse_iterator__relational_operators() {
	...
	ft::map<int, std::string>::const_reverse_iterator itA = mapA.rbegin();
	ft::map<int, std::string>::const_reverse_iterator itB = mapB.rbegin();
	ft::map<int, std::string>::const_reverse_iterator itC = itA;

			std::cout << "  map<int, std::string>::const_reverse_iterator itA = mapA.rbegin();" << std::endl;
			std::cout << "  map<int, std::string>::const_reverse_iterator itB = mapB.rbegin();" << std::endl;
			std::cout << "  map<int, std::string>::const_reverse_iterator itC = itA;" << std::endl << std::endl;
			std::cout << "      itA->first is	" << itA->first << std::endl;
			std::cout << "      itA->second is	" << itA->second << std::endl << std::endl;
			std::cout << "      itB->first is	" << itB->first << std::endl;
...
void	testMap::member_types__const_reverse_iterator__dereferences() {
	...
	ft::map<int, std::string>::const_reverse_iterator itC = itA;
			...
			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itA = mapA.rbegin();" << std::endl;
			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itB = mapB.rbegin();" << std::endl;
			std::cout << "  ft::map<int, std::string>::const_reverse_iterator itC = itA;" << std::endl << std::endl;
			std::cout << "      itA->first is	" << itA->first << std::endl;
			std::cout << "      itA->second is	" << itA->second << std::endl << std::endl;
			std::cout << "      itB->first is	" << itB->first << std::endl;
			std::cout << "      itB->second is	" << itB->second << std::endl << std::endl;
...
void	testMap::member_types__const_reverse_iterator__increment_decrement_operators() {
...
void	testMap::member_types__const_reverse_iterator__extras__iterator_to_const_iterator() {
	...
	ft::map<int, std::string>::const_reverse_iterator const_itA = mapA.rbegin();

			std::cout << "  map<int, std::string>::reverse_iterator itA = mapA.rbegin();" << std::endl;
			std::cout << "  map<int, std::string>::const_reverse_iterator const_itA = mapA.rbegin();" << std::endl;
			std::cout << std::endl;
