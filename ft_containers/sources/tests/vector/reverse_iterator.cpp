...
void	testVector::member_types__reverse_iterator__default_member_functions() {
	...
	ft::vector<int>::reverse_iterator itB = vectorB.rbegin();
			std::cout << "  vector<int>::reverse_iterator itA = vectorA.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itB = vectorB.rbegin();" << std::endl << std::endl;
	...
	ft::vector<int>::reverse_iterator itDefault;
			std::cout << "  vector<int>::reverse_iterator	itDefault;" << std::endl;
			std::cout << std::endl;
	...
	ft::vector<int>::reverse_iterator itCopyConstructor(itA);

			std::cout << "  vector<int>::reverse_iterator	itCopyConstructor(itA);" << std::endl << std::endl;
	...
	ft::vector<int>::reverse_iterator itCopyAssigment = itA;

			std::cout << "  vector<int>::reverse_iterator itCopyAssigment = itA;" << std::endl << std::endl;
...
void	testVector::member_types__reverse_iterator__relational_operators() {
	...
	ft::vector<int>::reverse_iterator itA = vectorA.rbegin();
	ft::vector<int>::reverse_iterator itB = vectorB.rbegin();
	ft::vector<int>::reverse_iterator itC = itA;

			std::cout << "  vector<int>::reverse_iterator itA = vectorA.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itB = vectorB.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itC = itA;" << std::endl << std::endl;
			std::cout << "      *itA is	" << *itA << std::endl;
			std::cout << "      *itB is	" << *itB << std::endl;
...
void	testVector::member_types__reverse_iterator__arithmetic_operators() {
	...
	ft::vector<int>::reverse_iterator itE = vectorC.rend();

			std::cout << "  vector<int>::reverse_iterator itA = vectorA.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itB = vectorB.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itC = itA;" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itD = vectorC.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itE = vectorC.rend();" << std::endl << std::endl;
			std::cout << "      *itA is	" << *itA << std::endl;
			std::cout << "      *itB is	" << *itB << std::endl;
			std::cout << "      *itC is	" << *itC << std::endl;
			std::cout << "      *itD is	" << *itD << std::endl << std::endl;
...
void	testVector::member_types__reverse_iterator__base() {
	...
	ft::vector<int>::reverse_iterator itA = vectorA.rbegin();
	ft::vector<int>::reverse_iterator itB = vectorB.rbegin();
	ft::vector<int>::reverse_iterator::iterator_type baseA = itA.base();
	ft::vector<int>::reverse_iterator::iterator_type baseB = itB.base();

			std::cout << "  vector<int>::reverse_iterator itA = vectorA.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator itB = vectorB.rbegin();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator::iterator_type baseA = itA.base();" << std::endl;
			std::cout << "  vector<int>::reverse_iterator::iterator_type baseB = itB.base();" << std::endl << std::endl;
